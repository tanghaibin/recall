...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"这是必填项",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_48d,blur:_491,mouseenter:_494,mouseleave:_497,click:function(e){
var t=$(e.data.target);
...
$(this).tooltip("tip").css({color:"white",backgroundColor:"#2194DE"});
},onHide:function(){
$(this).tooltip("destroy");
...
},message:"请输入正确的邮箱格式"},url:{validator:function(_4bc){
...
},message:"字符在 {0} ~ {1} 之间"},remote:{validator:function(_4bf,_4c0){
var data={};
data[_4c0[1]]=_4bf;
